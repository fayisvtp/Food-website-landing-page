...
import img1 from './images/frozen3.jpg'
import img2 from './images/non-veg.jpg'
        ...
        <div className="col-md-7 d-flex align-items-center">
          <div className="heading-texts col-12 p-5">
            ...
            <p className="heding_para text-light">
              ...
              nemo cupiditate sapiente magnam vel totam. Ullam et itaque
              distinctio
            </p>
            ...
            <div className="heading_buttons d-flex align-items-center">
              <div className="heading_btn">
                <p className="explore px-2">
                  <span className="heading_btn-1">Explore</span>
